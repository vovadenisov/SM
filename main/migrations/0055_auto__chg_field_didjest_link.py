...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Didjest.link'
        db.alter_column(u'main_didjest', 'link', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True))

    def backwards(self, orm):

        # Changing field 'Didjest.link'
        db.alter_column(u'main_didjest', 'link', self.gf('django.db.models.fields.CharField')(default='', max_length=250))

    models = {
        u'main.about_decan': {
            'Meta': {'object_name': 'About_Decan'},
        ...
        u'main.articles': {
            ...
            'photo': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['photologue.Photo']"}),
            'pub_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 10, 8, 0, 0)'}),
        ...
        u'main.didjest': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'link': ('django.db.models.fields.files.FileField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
