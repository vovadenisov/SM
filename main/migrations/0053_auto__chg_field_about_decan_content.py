...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'About_Decan.content'
        db.alter_column(u'main_about_decan', 'content', self.gf('ckeditor.fields.RichTextField')())

    def backwards(self, orm):

        # Changing field 'About_Decan.content'
        db.alter_column(u'main_about_decan', 'content', self.gf('django.db.models.fields.TextField')())
    ...
    models = {
        ...
        u'main.articles': {
            ...
            'photo': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['photologue.Photo']"}),
            'pub_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 6, 18, 0, 0)'}),
