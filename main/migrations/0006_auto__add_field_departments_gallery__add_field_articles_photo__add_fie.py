...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'main_departments', 'gallery',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['photologue.Gallery'], null=True, on_delete=models.SET_NULL, blank=True),
                      keep_default=False)

        # Adding field 'Articles.photo'
        db.add_column(u'main_articles', 'photo',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['photologue.Photo'], null=True, on_delete=models.SET_NULL, blank=True),
                      keep_default=False)
        ...
        # Adding field 'Projects.photo'
        db.add_column(u'main_projects', 'photo',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['photologue.Photo'], null=True, on_delete=models.SET_NULL, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Articles.photo'
        db.delete_column(u'main_articles', 'photo_id')

        # Deleting field 'Articles.gallery'
        db.delete_column(u'main_articles', 'gallery_id')

        # Deleting field 'Projects.photo'
        db.delete_column(u'main_projects', 'photo_id')
