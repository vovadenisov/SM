...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal(u'main', ['units'])


        # Adding SortedM2M table for field article on 'units'
        db.create_table(u'main_units_article', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('units', models.ForeignKey(orm[u'main.units'], null=False)),
            ('articles', models.ForeignKey(orm[u'main.articles'], null=False)),
            ('sort_value', models.IntegerField())
        ))
        db.create_unique(u'main_units_article', ['units_id', 'articles_id'])

    def backwards(self, orm):
        # Deleting model 'units'
        db.delete_table(u'main_units')

        # Removing M2M table for field article on 'units'
        db.delete_table(db.shorten_name(u'main_units_article'))
