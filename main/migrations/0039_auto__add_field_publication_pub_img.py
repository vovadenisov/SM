...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Publication.pub_img'
        db.add_column(u'main_publication', 'pub_img',
    ...
    def backwards(self, orm):
        # Deleting field 'Publication.pub_img'
        db.delete_column(u'main_publication', 'pub_img_id')
