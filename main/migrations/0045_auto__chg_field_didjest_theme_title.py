...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Didjest_theme.title'
        db.alter_column(u'main_didjest_theme', 'title', self.gf('django.db.models.fields.CharField')(max_length=250))

    def backwards(self, orm):

        # Changing field 'Didjest_theme.title'
        db.alter_column(u'main_didjest_theme', 'title', self.gf('django.db.models.fields.CharField')(max_length=200))
