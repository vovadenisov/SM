...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Didjest_year.year'
        db.alter_column(u'main_didjest_year', 'year', self.gf('django.db.models.fields.CharField')(max_length=50))

    def backwards(self, orm):

        # Changing field 'Didjest_year.year'
        db.alter_column(u'main_didjest_year', 'year', self.gf('django.db.models.fields.CharField')(max_length=30))
