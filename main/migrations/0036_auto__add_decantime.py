...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'decanTime'
        db.create_table(u'main_decantime', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('Monday', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('Tuesday', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('Stead', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('Thursday', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('Friday', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('Saturday', self.gf('django.db.models.fields.CharField')(max_length=50)),
        ))
        db.send_create_signal(u'main', ['decanTime'])


    def backwards(self, orm):
        # Deleting model 'decanTime'
        db.delete_table(u'main_decantime')
