...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'decanTime.name'
        db.delete_column(u'main_decantime', 'name')
        ...
        # Adding field 'decanTime.date'
        db.add_column(u'main_decantime', 'date',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2015, 6, 17, 0, 0)),
                      keep_default=False)

        # Adding field 'decanTime.decan'
        db.add_column(u'main_decantime', 'decan',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Deleting field 'Didjest.pub_date'
        db.delete_column(u'main_didjest', 'pub_date')

        # Adding field 'Didjest.number'
        db.add_column(u'main_didjest', 'number',
    ...
    def backwards(self, orm):
        ...
        # Adding field 'decanTime.name'
        db.add_column(u'main_decantime', 'name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50),
                      keep_default=False)
        ...
        # Deleting field 'decanTime.date'
        db.delete_column(u'main_decantime', 'date')

        # Deleting field 'decanTime.decan'
        db.delete_column(u'main_decantime', 'decan')

        # Adding field 'Didjest.pub_date'
        db.add_column(u'main_didjest', 'pub_date',
                      self.gf('django.db.models.fields.DateTimeField')(default=''),
                      keep_default=False)

        # Deleting field 'Didjest.number'
        db.delete_column(u'main_didjest', 'number')
