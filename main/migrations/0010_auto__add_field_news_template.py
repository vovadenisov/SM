...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'News.template'
        db.add_column(u'main_news', 'template',
                      self.gf('django.db.models.fields.CharField')(default='news.html', max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'News.template'
        db.delete_column(u'main_news', 'template')
