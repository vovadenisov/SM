...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AboutBMSTU.facts_title'
        db.add_column(u'main_aboutbmstu', 'facts_title',
                      self.gf('django.db.models.fields.CharField')(default=datetime.datetime(2014, 5, 28, 0, 0), max_length=250),
                      keep_default=False)

        # Adding field 'AboutBMSTU.facts_text'
        db.add_column(u'main_aboutbmstu', 'facts_text',
                      self.gf('ckeditor.fields.RichTextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'AboutBMSTU.facts_photo'
        db.add_column(u'main_aboutbmstu', 'facts_photo',
        ...
        # Adding field 'AboutBMSTU.facts_gallery'
        db.add_column(u'main_aboutbmstu', 'facts_gallery',
    ...
    def backwards(self, orm):
        # Deleting field 'AboutBMSTU.facts_title'
        db.delete_column(u'main_aboutbmstu', 'facts_title')

        # Deleting field 'AboutBMSTU.facts_text'
        db.delete_column(u'main_aboutbmstu', 'facts_text')

        # Deleting field 'AboutBMSTU.facts_photo'
        db.delete_column(u'main_aboutbmstu', 'facts_photo_id')

        # Deleting field 'AboutBMSTU.facts_gallery'
        db.delete_column(u'main_aboutbmstu', 'facts_gallery_id')
