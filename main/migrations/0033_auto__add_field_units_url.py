...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'units.url'
        db.add_column(u'main_units', 'url',
                      self.gf('django.db.models.fields.CharField')(default='exit', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'units.url'
        db.delete_column(u'main_units', 'url')
