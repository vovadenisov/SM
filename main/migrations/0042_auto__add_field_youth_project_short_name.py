...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Youth_project.short_name'
        db.add_column(u'main_youth_project', 'short_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Youth_project.short_name'
        db.delete_column(u'main_youth_project', 'short_name')
