...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Didjest'
        db.create_table(u'main_didjest', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=150)),
            ('link', self.gf('django.db.models.fields.CharField')(max_length=250)),
            ('pub_date', self.gf('django.db.models.fields.DateTimeField')()),
            ('year', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.Didjest_year'])),
        ))
        db.send_create_signal(u'main', ['Didjest'])

        # Adding model 'Didjest_year'
        db.create_table(u'main_didjest_year', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('year', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('theme', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.Didjest_theme'])),
        ))
        db.send_create_signal(u'main', ['Didjest_year'])

        # Adding model 'Didjest_theme'
        db.create_table(u'main_didjest_theme', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ))
        db.send_create_signal(u'main', ['Didjest_theme'])


    def backwards(self, orm):
        # Deleting model 'Didjest'
        db.delete_table(u'main_didjest')

        # Deleting model 'Didjest_year'
        db.delete_table(u'main_didjest_year')

        # Deleting model 'Didjest_theme'
        db.delete_table(u'main_didjest_theme')
    ...
    models = {
        ...
        u'main.articles': {
            ...
            'photo': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['photologue.Photo']"}),
            'pub_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 6, 15, 0, 0)'}),
