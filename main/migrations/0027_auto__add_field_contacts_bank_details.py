...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Contacts.bank_details'
        db.add_column(u'main_contacts', 'bank_details',
                      self.gf('ckeditor.fields.RichTextField')(default=datetime.datetime(2014, 5, 27, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Contacts.bank_details'
        db.delete_column(u'main_contacts', 'bank_details')
