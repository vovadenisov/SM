...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Articles.author'
        db.add_column(u'main_articles', 'author',
                      self.gf('django.db.models.fields.CharField')(default=datetime.datetime(2014, 5, 10, 0, 0), max_length=250),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Articles.author'
        db.delete_column(u'main_articles', 'author')
    ...
    models = {
        ...
        u'main.articles': {
            ...
            'photo': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['photologue.Photo']"}),
            'pub_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 5, 10, 0, 0)'}),
