...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Units.url'
        db.alter_column(u'main_units', 'url', self.gf('django.db.models.fields.CharField')(max_length=150))

    def backwards(self, orm):

        # Changing field 'Units.url'
        db.alter_column(u'main_units', 'url', self.gf('django.db.models.fields.CharField')(max_length=100))
