...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Didjest.link'
        db.delete_column(u'main_didjest', 'link')

        # Adding field 'Didjest.file'
        db.add_column(u'main_didjest', 'file',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Didjest.link'
        db.add_column(u'main_didjest', 'link',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Didjest.file'
        db.delete_column(u'main_didjest', 'file')
