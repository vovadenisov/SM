...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Emails'
        db.create_table(u'main_emails', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('email', self.gf('django.db.models.fields.CharField')(max_length=250)),
        ))
        db.send_create_signal(u'main', ['Emails'])

        # Adding model 'Phones'
        db.create_table(u'main_phones', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('phone_number', self.gf('django.db.models.fields.CharField')(max_length=250)),
        ))
        db.send_create_signal(u'main', ['Phones'])

        # Adding model 'Addresses'
        db.create_table(u'main_addresses', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('address', self.gf('django.db.models.fields.CharField')(max_length=250)),
        ))
        db.send_create_signal(u'main', ['Addresses'])

        # Deleting field 'Contacts.phone_number'
        db.delete_column(u'main_contacts', 'phone_number')

        # Deleting field 'Contacts.adress'
        db.delete_column(u'main_contacts', 'adress')


        # Adding SortedM2M table for field phone_number on 'Contacts'
        db.create_table(u'main_contacts_phone_number', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('contacts', models.ForeignKey(orm[u'main.contacts'], null=False)),
            ('phones', models.ForeignKey(orm[u'main.phones'], null=False)),
            ('sort_value', models.IntegerField())
        ))
        db.create_unique(u'main_contacts_phone_number', ['contacts_id', 'phones_id'])

        # Adding SortedM2M table for field addresses on 'Contacts'
        db.create_table(u'main_contacts_addresses', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('contacts', models.ForeignKey(orm[u'main.contacts'], null=False)),
            ('addresses', models.ForeignKey(orm[u'main.addresses'], null=False)),
            ('sort_value', models.IntegerField())
        ))
        db.create_unique(u'main_contacts_addresses', ['contacts_id', 'addresses_id'])

        # Adding SortedM2M table for field emails on 'Contacts'
        db.create_table(u'main_contacts_emails', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('contacts', models.ForeignKey(orm[u'main.contacts'], null=False)),
            ('emails', models.ForeignKey(orm[u'main.emails'], null=False)),
            ('sort_value', models.IntegerField())
        ))
        db.create_unique(u'main_contacts_emails', ['contacts_id', 'emails_id'])
        # Adding field 'Departments.content'
        db.add_column(u'main_departments', 'content',
                      self.gf('ckeditor.fields.RichTextField')(default=datetime.datetime(2014, 5, 27, 0, 0)),
                      keep_default=False)


        # Changing field 'AboutBMSTU.history_text'
        db.alter_column(u'main_aboutbmstu', 'history_text', self.gf('ckeditor.fields.RichTextField')())

    def backwards(self, orm):
        # Deleting model 'Emails'
        db.delete_table(u'main_emails')

        # Deleting model 'Phones'
        db.delete_table(u'main_phones')

        # Deleting model 'Addresses'
        db.delete_table(u'main_addresses')

        # Adding field 'Contacts.phone_number'
        db.add_column(u'main_contacts', 'phone_number',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=250, blank=True),
                      keep_default=False)

        # Adding field 'Contacts.adress'
        db.add_column(u'main_contacts', 'adress',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=250, blank=True),
                      keep_default=False)

        # Removing M2M table for field phone_number on 'Contacts'
        db.delete_table(db.shorten_name(u'main_contacts_phone_number'))

        # Removing M2M table for field addresses on 'Contacts'
        db.delete_table(db.shorten_name(u'main_contacts_addresses'))

        # Removing M2M table for field emails on 'Contacts'
        db.delete_table(db.shorten_name(u'main_contacts_emails'))

        # Deleting field 'Departments.content'
        db.delete_column(u'main_departments', 'content')


        # Changing field 'AboutBMSTU.history_text'
        db.alter_column(u'main_aboutbmstu', 'history_text', self.gf('django.db.models.fields.TextField')())
    ...
    models = {
        ...
        u'main.articles': {
            ...
            'photo': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['photologue.Photo']"}),
            'pub_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 5, 27, 0, 0)'}),
