...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'AboutBMSTU'
        db.create_table(u'main_aboutbmstu', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('gallery', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, on_delete=models.SET_NULL, to=orm['photologue.Gallery'])),
            ('history_title', self.gf('django.db.models.fields.CharField')(max_length=250)),
            ('history_text', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('history_photo', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, on_delete=models.SET_NULL, to=orm['photologue.Photo'])),
            ('history_gallery', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, on_delete=models.SET_NULL, to=orm['photologue.Gallery'])),
            ('nowadays_title', self.gf('django.db.models.fields.CharField')(max_length=250)),
            ('nowadays_text', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('nowadays_photo', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, on_delete=models.SET_NULL, to=orm['photologue.Photo'])),
            ('tree_title', self.gf('django.db.models.fields.CharField')(max_length=250)),
            ('tree_photo', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, on_delete=models.SET_NULL, to=orm['photologue.Photo'])),
        ))
        db.send_create_signal(u'main', ['AboutBMSTU'])

        # Adding M2M table for field article on 'AboutBMSTU'
        m2m_table_name = db.shorten_name(u'main_aboutbmstu_article')
        ...
        db.create_unique(m2m_table_name, ['aboutbmstu_id', 'articles_id'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'AboutBMSTU'
        db.delete_table(u'main_aboutbmstu')
    ...
    models = {
        u'main.aboutbmstu': {
            ...
            'graduate': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['main.Graduates']", 'symmetrical': 'False', 'blank': 'True'}),
