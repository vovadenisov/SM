...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Youth_project.photo'
        db.add_column(u'main_youth_project', 'photo',
    ...
    def backwards(self, orm):
        # Deleting field 'Youth_project.photo'
        db.delete_column(u'main_youth_project', 'photo_id')
    ...
    models = {
        ...
        u'main.articles': {
            ...
            'photo': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['photologue.Photo']"}),
            'pub_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 6, 13, 0, 0)'}),
