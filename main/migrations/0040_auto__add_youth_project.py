...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Youth_project'
        db.create_table(u'main_youth_project', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('content', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('link', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal(u'main', ['Youth_project'])


    def backwards(self, orm):
        # Deleting model 'Youth_project'
        db.delete_table(u'main_youth_project')
