...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Projects.isFavorite'
        db.add_column(u'main_projects', 'isFavorite',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Projects.isFavorite'
        db.delete_column(u'main_projects', 'isFavorite')
    ...
    models = {
        ...
        u'main.articles': {
            ...
            'photo': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['photologue.Photo']"}),
            'pub_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 5, 11, 0, 0)'}),
