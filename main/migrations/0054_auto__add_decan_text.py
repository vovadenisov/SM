...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Decan_text'
        db.create_table(u'main_decan_text', (
        ...
        db.send_create_signal(u'main', ['Decan_text'])


    def backwards(self, orm):
        # Deleting model 'Decan_text'
        db.delete_table(u'main_decan_text')
    ...
    models = {
        ...
        u'main.articles': {
            ...
            'photo': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['photologue.Photo']"}),
            'pub_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 6, 21, 0, 0)'}),
