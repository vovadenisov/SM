...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Publication.name'
        db.delete_column(u'main_publication', 'name')

        # Deleting field 'Publication.autor'
        db.delete_column(u'main_publication', 'autor')

        # Deleting field 'Publication.link'
        db.delete_column(u'main_publication', 'link')

        # Adding field 'Publication.pub_name'
        db.add_column(u'main_publication', 'pub_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=150),
                      keep_default=False)

        # Adding field 'Publication.pub_autor'
        db.add_column(u'main_publication', 'pub_autor',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=150),
                      keep_default=False)

        # Adding field 'Publication.pub_link'
        db.add_column(u'main_publication', 'pub_link',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=150),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Publication.name'
        db.add_column(u'main_publication', 'name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=150),
                      keep_default=False)

        # Adding field 'Publication.autor'
        db.add_column(u'main_publication', 'autor',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=150),
                      keep_default=False)

        # Adding field 'Publication.link'
        db.add_column(u'main_publication', 'link',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=150),
                      keep_default=False)

        # Deleting field 'Publication.pub_name'
        db.delete_column(u'main_publication', 'pub_name')

        # Deleting field 'Publication.pub_autor'
        db.delete_column(u'main_publication', 'pub_autor')

        # Deleting field 'Publication.pub_link'
        db.delete_column(u'main_publication', 'pub_link')
