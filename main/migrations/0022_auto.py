...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Adding SortedM2M table for field article on 'Departments'
        db.create_table(u'main_departments_article', (
        ...
        db.create_unique(u'main_departments_article', ['departments_id', 'articles_id'])
