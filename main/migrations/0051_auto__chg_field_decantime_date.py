...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'decanTime.date'
        db.alter_column(u'main_decantime', 'date', self.gf('django.db.models.fields.CharField')(max_length=50))

    def backwards(self, orm):

        # Changing field 'decanTime.date'
        db.alter_column(u'main_decantime', 'date', self.gf('django.db.models.fields.DateTimeField')())
