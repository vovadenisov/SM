...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Articles.gallery'
        db.delete_column(u'main_articles', 'gallery_id')

        # Deleting field 'Departments.gallery'
        db.delete_column(u'main_departments', 'gallery_id')

        # Deleting field 'AboutBMSTU.nowadays_title'
        db.delete_column(u'main_aboutbmstu', 'nowadays_title')

        # Deleting field 'AboutBMSTU.nowadays_photo'
        db.delete_column(u'main_aboutbmstu', 'nowadays_photo_id')

        # Deleting field 'AboutBMSTU.nowadays_text'
        db.delete_column(u'main_aboutbmstu', 'nowadays_text')

        # Deleting field 'AboutBMSTU.gallery'
        db.delete_column(u'main_aboutbmstu', 'gallery_id')

        # Adding field 'AboutBMSTU.tradition_title'
        db.add_column(u'main_aboutbmstu', 'tradition_title',
                      self.gf('django.db.models.fields.CharField')(default=datetime.datetime(2014, 5, 28, 0, 0), max_length=250),
                      keep_default=False)

        # Adding field 'AboutBMSTU.tradition_text'
        db.add_column(u'main_aboutbmstu', 'tradition_text',
                      self.gf('ckeditor.fields.RichTextField')(default=datetime.datetime(2014, 5, 28, 0, 0)),
                      keep_default=False)

        # Adding field 'AboutBMSTU.tradition_photo'
        db.add_column(u'main_aboutbmstu', 'tradition_photo',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, on_delete=models.SET_NULL, to=orm['photologue.Photo']),
                      keep_default=False)

        # Adding field 'AboutBMSTU.tradition_gallery'
        db.add_column(u'main_aboutbmstu', 'tradition_gallery',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, on_delete=models.SET_NULL, to=orm['photologue.Gallery']),
                      keep_default=False)

        # Adding field 'AboutBMSTU.graduates_title'
        db.add_column(u'main_aboutbmstu', 'graduates_title',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=250, blank=True),
                      keep_default=False)

        # Deleting field 'Projects.gallery'
        db.delete_column(u'main_projects', 'gallery_id')


    def backwards(self, orm):
        # Adding field 'Articles.gallery'
        db.add_column(u'main_articles', 'gallery',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', null=True, to=orm['photologue.Gallery'], on_delete=models.SET_NULL, blank=True),
                      keep_default=False)

        # Adding field 'Departments.gallery'
        db.add_column(u'main_departments', 'gallery',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', null=True, to=orm['photologue.Gallery'], on_delete=models.SET_NULL, blank=True),
                      keep_default=False)

        # Adding field 'AboutBMSTU.nowadays_title'
        db.add_column(u'main_aboutbmstu', 'nowadays_title',
                      self.gf('django.db.models.fields.CharField')(default=datetime.datetime(2014, 5, 28, 0, 0), max_length=250),
                      keep_default=False)

        # Adding field 'AboutBMSTU.nowadays_photo'
        db.add_column(u'main_aboutbmstu', 'nowadays_photo',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', null=True, to=orm['photologue.Photo'], on_delete=models.SET_NULL, blank=True),
                      keep_default=False)

        # Adding field 'AboutBMSTU.nowadays_text'
        db.add_column(u'main_aboutbmstu', 'nowadays_text',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'AboutBMSTU.gallery'
        db.add_column(u'main_aboutbmstu', 'gallery',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', null=True, to=orm['photologue.Gallery'], on_delete=models.SET_NULL, blank=True),
                      keep_default=False)

        # Deleting field 'AboutBMSTU.tradition_title'
        db.delete_column(u'main_aboutbmstu', 'tradition_title')

        # Deleting field 'AboutBMSTU.tradition_text'
        db.delete_column(u'main_aboutbmstu', 'tradition_text')

        # Deleting field 'AboutBMSTU.tradition_photo'
        db.delete_column(u'main_aboutbmstu', 'tradition_photo_id')

        # Deleting field 'AboutBMSTU.tradition_gallery'
        db.delete_column(u'main_aboutbmstu', 'tradition_gallery_id')

        # Deleting field 'AboutBMSTU.graduates_title'
        db.delete_column(u'main_aboutbmstu', 'graduates_title')

        # Adding field 'Projects.gallery'
        db.add_column(u'main_projects', 'gallery',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', null=True, to=orm['photologue.Gallery'], on_delete=models.SET_NULL, blank=True),
                      keep_default=False)
    ...
    models = {
        u'main.aboutbmstu': {
            ...
            'history_text': ('ckeditor.fields.RichTextField', [], {}),
            ...
            'tradition_text': ('ckeditor.fields.RichTextField', [], {}),
